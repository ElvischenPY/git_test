...
extern int g_boot_fwv_greater_check;
...
extern int synaptics_fw_configid(struct synaptics_rmi4_data *rmi4_data);
extern int synaptics_get_configid(u8 *buf, size_t buf_size);
#endif
