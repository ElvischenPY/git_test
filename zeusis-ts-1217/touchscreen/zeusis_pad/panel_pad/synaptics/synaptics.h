...
#define WAKEUP_GESTURE_ENABLE 1
...
extern int g_pad_boot_fwv_greater_check;

extern int pad_synaptics_fw_data_init(struct synaptics_rmi4_data *rmi4_data);
extern bool pad_synaptics_check_fw_version(void);
extern int pad_synaptics_get_fw_data_boot(char *file_name,struct touch_settings *synaptics_sett_param_regs);
extern int pad_synaptics_get_fw_data_sd(void);
extern void pad_synaptics_fw_data_release(void);
extern int pad_synaptics_fw_update(void);
extern int pad_synaptics_fw_data_s3718_init(struct synaptics_rmi4_data *rmi4_data);
extern bool pad_synaptics_check_fw_s3718_version(void);
extern int pad_synaptics_get_fw_data_s3718_boot(char *file_name,struct touch_settings *synaptics_sett_param_regs);
extern int pad_synaptics_get_fw_data_s3718_sd(void);
extern void pad_synaptics_fw_data_s3718_release(void);
extern int pad_synaptics_fw_s3718_update(void);
extern int pad_synaptics_fw_s3718_configid(struct synaptics_rmi4_data *rmi4_data);
extern int pad_synaptics_get_s3718_configid(u8 *buf, size_t buf_size);
extern int pad_synaptics_rmi4_f54_s3207_init(struct synaptics_rmi4_data *rmi4_data,const char *module_name);
extern int pad_synaptics_rmi4_f54_init(struct synaptics_rmi4_data *rmi4_data,const char *module_name);
#ifdef RED_REMOTE
extern void pad_synaptics_fw_debug_dev_init(struct synaptics_rmi4_data *rmi4_data);
extern void pad_rmidev_sysfs_irq(void *data);
#endif
extern int pad_synaptics_get_cap_data(struct ts_rawdata_info *info);
extern int pad_synaptics_fw_configid(struct synaptics_rmi4_data *rmi4_data);
extern int pad_synaptics_get_configid(u8 *buf, size_t buf_size);
#endif
