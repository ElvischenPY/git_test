...
#define GTP_MAX_TOUCH    			TP_MAX_FINGER
...
extern struct goodix_ts_data *pad_goodix_ts;
extern struct fw_update_info pad_update_info;
...
#define GTP_INFO(fmt,arg...)           TP_LOG_INFO("[GTP-INF][%s:%d] "fmt"\n", __func__, __LINE__, ##arg)
#define GTP_ERROR(fmt,arg...)          TP_LOG_ERR("[GTP-ERR][%s:%d] "fmt"\n", __func__, __LINE__, ##arg)
#define GTP_DEBUG(fmt,arg...)          TP_LOG_DEBUG("[GTP-DBG][%s:%d]"fmt"\n",__func__, __LINE__, ##arg)
#define GTP_DEBUG_FUNC()               do{\
										 if(GTP_DEBUG_FUNC_ON)\
										 TP_LOG_DEBUG("[GTP-FUNC] Func:%s@Line:%d\n",__func__,__LINE__);\
									   }while(0)
...
extern int pad_gt1x_init_tool_node(void);
extern int pad_gt1x_auto_update_proc(int type);
extern int pad_goodix_get_rawdata(struct ts_rawdata_info *info,
