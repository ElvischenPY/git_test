...
#define HT_KEY_BACK  158
#define HT_KEY_HOME 172
#define HT_KEY_MENU 139


#define HT_KEY_BACK_POS_X  100
#define HT_KEY_BACK_POS_Y  1321

#define HT_KEY_HOME_POS_X  360
#define HT_KEY_HOME_POS_Y  1321

#define HT_KEY_MENU_POS_X  620
#define HT_KEY_MENU_POS_Y  1321

#define CONFIG_HT_TP_FTDEBUG
...
#if defined(CONFIG_HT_TP_FTDEBUG)
...
printk("====cbw==== ft5x06 %s:[%d] start  \n",__func__,__LINE__);
	...
	input_set_capability(input_dev, EV_KEY, HT_KEY_BACK);
	input_set_capability(input_dev, EV_KEY, HT_KEY_HOME);
	input_set_capability(input_dev, EV_KEY, HT_KEY_MENU);
...
printk("====cbw==== ft5x06 %s:[%d]   probe end  \n",__func__,__LINE__);
	return 0;
